...
public class ReviewListTest {
    ...
    void setUp() {
        ...
        Review review1 = createReview(place, "맛있어요", 5, List.of("url1", "url2"), List.of(tag1, tag2));
        Review review2 = createReview(place, "별로에요", 2, List.of("url3"), List.of(tag2));
    ...
    private Review createReview(Place place, String content, int rating, List<String> images, List<Tag> tags) {
